...
# sum_angles(angle, mod)            - Sums two integer angles, returning a 
#                                     positive angle
# str_to_int_list(string, separator)- Turns a string into a list of ints
################################################################################
...
# Sums two integer angles, returning a positive angle
...
# str_to_int_list(string, separator)
# Turns a string into a list of ints
def str_to_int_list(string, separator):
    int_list = []
    for val in string.split(separator):
        if val.isdigit():
